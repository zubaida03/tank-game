...
public class collision extends ApplicationAdapter implements Screen, InputProcessor {
    SpriteBatch batch;
    Sprite sprite;
    Texture img;
    World world;
    ...
    public collision(Very_Tank game) {
        this.game = game;
        batch = new SpriteBatch();
        img = new Texture("tan2_img.png");
