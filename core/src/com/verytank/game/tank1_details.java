...
//    tank details
    ...
    private Texture t2blur;
    private Rectangle t2blurRect;
    private Texture t1blur;
    private Rectangle t1blurRect;
    ...
    public tank1_details (Very_Tank game,new_game_tank_confirm new_game_tank_confirm,String name) {
        ...
        details = new Texture("tank1_details.png");
        detailsRect = new Rectangle(900, 200, 900, 700);
        t2blur = new Texture("t2blur.png");
        t2blurRect = new Rectangle(100, 187, 300, 200);
        t1blur = new Texture("t3blur.png");
        t1blurRect = new Rectangle(400, 200, 300, 200);
