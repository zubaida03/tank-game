...
//                player1_tank.setCurrX(player1Body.getPosition().x);
//                player1_tank.setCurrY(player1Body.getPosition().y);
...
//                player2_tank.setCurrX(player2Body.getPosition().x);
//                player2_tank.setCurrY(player2Body.getPosition().y);
            }
...
//        testWeapon.getPosition().y=player1Body.getPosition().y;
        ...
        if (testWeapon == null) {
            ...
            game.batch.draw(weapon1.getTexture(), testWeapon.getPosition().x / scaling, testWeapon.getPosition().y / scaling, 0, 0, 50, 50, 1, 1, testWeapon.getAngle(), 0, 0, (int) (w_1.getTextureData().getWidth()), (int) (w_1.getTextureData().getHeight()), false, false);
            if (turn == 1) {
                if (collision_checker(player2Body, testWeapon)) {
                    System.out.println("Collision");
                    if (health2Bounds2.width - speed * weapon1.getMaxpower() > 0) {
                        health2Bounds2.width -= speed * weapon1.getMaxpower();
                    }
                    else{
                ...
                if (collision_checker(player1Body, testWeapon)) {
                    System.out.println("Collision");
                    if (health2Bounds1.width - speed * weapon1.getMaxpower() > 0) {
                        health2Bounds1.width -= speed * weapon1.getMaxpower();
                    }
                    else{
